...
_default_node_types_fname = _Path(
    _rsrc_fname(__name__, 'resources/node_types.py')
)
...
if _default_node_types_fname.is_file():
    ...
    raise FileNotFoundError(
        'File resources/node_types.py not found. This file is '
        'required to define the default node type names and their '
        'tables in the database.'
    )

_default_link_types_fname = _Path(
    _rsrc_fname(__name__, 'resources/link_types.py')
)
...
if _default_link_types_fname.is_file():
    ...
    raise FileNotFoundError(
        'File resources/link_types.py not found. This file is '
        'required to define the default edge type names.'
    )
...
_default_label_map_fname = _Path(
    _rsrc_fname(__name__, 'resources/label_map.csv')
)
...
if _default_label_map_fname.is_file():
    ...
    raise FileNotFoundError(
        'File resources/label_map.csv not found. This file is '
        'required to define the default mapping between data labels, '
        'node types, and edge types.'
    )

_default_label_map = _read_csv(
    _default_label_map_fname,
    header=0,
...
_default_sql_schema_fname = _Path(
    _rsrc_fname(__name__, 'resources/schema_script.sql')
)
...
if _default_sql_schema_fname.is_file():
    ...
    raise FileNotFoundError(
        'File resources/schema_script.sql not found. This file is '
        'required to define the default database schema.'
    )
