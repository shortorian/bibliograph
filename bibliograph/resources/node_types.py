...
###
{
    ...
    "agreements":{
        "description":"An agreement is any contract or other agreement "
               ...
               "a research project or a fellowship supporting a person."
    },
    ...
    "text_data":{
        ...
        "bibliograph database is stored in the strings table as "
        "csv-formatted text stored at the full_string_id of a "
        "text_data node.  The two exceptions are for data "
        "representing entry_rules nodes and relations_rules nodes, as "
        "described below. Gauranteed columns:\n"
        "\n"
        "comment_char: Optional. Single character to separate "
        "comments from data.",
    ...
    "entry_rules":{
        ...
        "node is csv-formatted text defining the labels and "
        "separators required to parse individual entries in input "
        "data. Gauranteed columns:\n"
        "\n"
        "item_separator: Required. String value of up to four "
        "characters which delimits items within an entry.\n"
        "\n"
        "default prefix: Optional. Prefix associated with any entries "
        "that do not begin with a prefix defined in the csv string "
        "associated with the entry_rules. If null, entries without a "
        "prefix will raise an error. Limit 12 characters.\n"
        "\n"
        "space_char: Optional. Character that will be replaced by a "
        "space unless escaped with a backslash.\n"
        "\n"
        "na_values: Optional. Space-delimited list of string values "
        "representing missing data. Limit 19 characters including "
        "spaces.",
    ...
    "relations_rules":{
        "description":"The string representation of a relations_rules "
        "node is csv-formatted text defining relations between "
        "entries in csv-formatted input data."
    }
}
